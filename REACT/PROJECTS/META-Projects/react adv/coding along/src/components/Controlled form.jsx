...
function Controlled() {
  ...
  const getIsFormValid = () => {
    ...
    return isFirstNameValid && isPasswordValid && isEmailValid && isRoleSelected;
  };
      ...
      <form onSubmit={handleSubmit}>
        <fieldset>
          ...
          <div className="Field">
            ...
            <input value={password.value} onBlur={() => { // Set isTouched to true when the input loses focus
                setPassword((prev) => ({ ...prev, isTouched: true }));
              }} onChange={(e)=>{setPassword({  value: e.target.value,
    isTouched: true,})}}   type='password' placeholder="Password" />
